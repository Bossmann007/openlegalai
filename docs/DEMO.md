...
3. Cole um CNJ do TJPR, por exemplo `0000106-56.2014.8.16.0193`.
...
curl -s http://127.0.0.1:3000/api/mcp \
  -H 'Authorization: Bearer demo-advogado' \
  -H 'Content-Type: application/json' \
  -d '{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"abrir_datajud","arguments":{"processNumber":"0000106-56.2014.8.16.0193","tribunal":"tjpr"}}}'
...
curl -s http://127.0.0.1:3000/api/mcp \
  -H 'Authorization: Bearer demo-advogado' \
  -H 'Content-Type: application/json' \
  -d '{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"comparar_datajud","arguments":{"processNumber":"0000106-56.2014.8.16.0193","tribunal":"tjpr"}}}'

# Estagiário não abre capa
curl -s http://127.0.0.1:3000/api/mcp \
  -H 'Authorization: Bearer demo-estagiario' \
  -H 'Content-Type: application/json' \
  -d '{"jsonrpc":"2.0","id":5,"method":"tools/call","params":{"name":"abrir_datajud","arguments":{"processNumber":"0000106-56.2014.8.16.0193"}}}'
```
...
curl -s http://127.0.0.1:3000/api/datajud/abrir \
  -H 'Content-Type: application/json' \
  -d '{"numeroProcesso":"0000106-56.2014.8.16.0193","tribunal":"tjpr"}'
